<template>
    <div class="row text-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="24" fill="rgba(255, 255, 255, 0.513)"
        stroke="currentColor" stroke-linecap="rectangle" stroke-linejoin="rectangle" stroke-width="2"
        class="d-block mb-2" role="img" viewBox="0 0 70.617 70.617" focusable="false">
